(function() {
  ...
  module.exports = StylusCompiler = (function() {
    ...
    StylusCompiler.prototype.compile = function(data, path, callback) {
      var _ref;
      return stylus(data).set('compress', true).set('firebug', !!((_ref = this.config.stylus) != null ? _ref.firebug : void 0)).include(sysPath.join(this.config.rootPath, 'app', 'styles')).use(nib()).render(callback);
    };
